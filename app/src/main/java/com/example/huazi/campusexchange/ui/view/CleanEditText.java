/**
 * @creation_time: 2017/10/01
 * @author: huazi
 * @e-mail: wanghuazhi_beijing@163.com
 * @describe: 带删除的输入框
 */
package com.example.huazi.campusexchange.ui.view;
...
public class CleanEditText extends AppCompatEditText {
    ...
    //按钮资源
    private final int CLEAR = R.mipmap.ic_delete_grey;
    //动画时长
    ...
    public CleanEditText(final Context context) {
        super(context);
        init(context);
    }

    public CleanEditText(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public CleanEditText(final Context context, final AttributeSet attrs, final int defStyleAttr) {
