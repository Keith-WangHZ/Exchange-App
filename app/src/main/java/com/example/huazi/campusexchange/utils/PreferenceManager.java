...
public class PreferenceManager {
    ...
    private static String SHARED_KEY_CHOOSE_SCHOOL = "SHARED_KEY_CHOOSE_SCHOOL";
    ...
    public String getCurrentSchoolname(){
        return mSharedPreferences.getString(SHARED_KEY_CHOOSE_SCHOOL, null);
    }

    public void setCurrentSchoolname(String schoolname){
        editor.putString(SHARED_KEY_CHOOSE_SCHOOL, schoolname).commit();
//        editor.commit();
    }
